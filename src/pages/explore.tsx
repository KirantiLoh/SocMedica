        ...
        <main className='w-full max-w-[600px] h-screen overflow-y-auto'>
            ...
            <section className="p-3 sm:px-5">
                ...
                <ul className='flex flex-wrap gap-10'>
                    {posts}
                    {postList?.pages[postList.pages.length - 1]?.nextCursor && (postList?.pages[0]?.allPosts?.length ?? 0) > 0 ? <Image src="/spinner.svg" alt="Loading..." width={96} height={96} className="mx-auto" /> : null}
                </ul>
            </section>
        </main>
    )
